    ...
    <div id="erp-shell" class="hidden flex h-screen w-screen overflow-hidden bg-slate-100 font-sans text-slate-900 antialiased animate-fade-in relative">
        ...
        <div class="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
            ...
            <div class="flex-1 flex min-h-0 overflow-hidden">
                ...
                <main class="flex-1 flex flex-col min-h-0 p-6 overflow-y-auto bg-slate-50 transition-all duration-300" id="main-workspace">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\AmbatuGrow-Inventory\resources\views/dashboard.blade.php ENDPATH**/ ?>